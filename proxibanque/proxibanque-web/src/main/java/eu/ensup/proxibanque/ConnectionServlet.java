...
import com.ensup.proxibanque.service.AuthentificationService;
 ...
 * @author lorris
 */
@WebServlet(urlPatterns = {"/ConnectionServlet"})
public class ConnectionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            connection = service.connect(login, password);
        ...
        if(connection == true)
        {
            ...
            try {
                request.setAttribute("idConseiller", dao.getIdConseiilerByUserPassword(login, password));
            } catch (SQLException ex) {
                Logger.getLogger(ConnectionServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
